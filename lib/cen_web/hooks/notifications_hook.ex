defmodule CenWeb.NotificationsHook do
  ...
  def handle_event("read_notifications", _unsigned_params, socket) do
    dbg(Communications.read_notifications(socket.assigns.current_user, socket.assigns.notifications))
    send_update(CenWeb.NotificationsComponent, %{id: "notifications", notifications: []})
    {:halt, socket}
  end
